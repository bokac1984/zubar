<ul>
    <li class="first-level-nav">
        <a href="#" <?php echo $typeActive == 1 ? 'class="active two-row"' : 'class="two-row"' ?>><?php echo $lang['page']['estetska']['title']; ?></a>
    ...
    <li class="first-level-nav">
        <a href="#" <?php echo $typeActive == 6 ? 'class="active two-row"' : 'class="two-row"' ?>><?php echo $lang['page']['opstastomatologija']['title'] ?></a>
        <ul class="second-level-nav">
