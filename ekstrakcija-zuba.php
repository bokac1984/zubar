        ...
        <div class="page">
            ...
            <section class="page-title">
                <div class="grid-row clearfix">
                    <h1><?php echo $lang['page']['oralnahirurgija']['ekstrakcija']['title']; ?></h1>					
                    <nav class="bread-crumbs">
                        ...
                        <a href="#"><?php echo $lang['page']['oralnahirurgija']['ekstrakcija']['title']; ?></a>
                    </nav>
                </div>
            </section>
            <!--/ page title -->
            ...
            <main class="page-content">
                <div class="grid-row">
                    <div class="grid-col grid-col-9">
                        ...
                        <p><?php echo $lang['page']['oralnahirurgija']['ekstrakcija']['opis'] ?></p><br>
                        <div class="kandidat">
