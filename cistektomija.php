        ...
        <div class="page">
            ...
            <section class="page-title">
                <div class="grid-row clearfix">
                    <h1><?php echo $lang['page']['oralnahirurgija']['Cistektomija']['title']; ?></h1>					
                    <nav class="bread-crumbs">
                        <a href="/"><?php echo $lang['menu']['home'] ?></a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;
                        <a href="#"><?php echo $lang['page']['oralnahirurgija']['title'] ?></a>
                        <a href="#"><?php echo $lang['page']['oralnahirurgija']['Cistektomija']['title']; ?></a>
                    </nav>
                </div>
            </section>
            <!--/ page title -->
            ...
            <main class="page-content">
                <div class="grid-row">
                    <div class="grid-col grid-col-9">
                        ...
                        <p><?php echo $lang['page']['oralnahirurgija']['Cistektomija']['opis'] ?></p><br>
                        <div class="kandidat">
