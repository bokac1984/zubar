        ...
        <div class="page">
            ...
            <div class="slider-wrapper">
                <section class="slider" id="slider">
                    <div class="ls-slide" data-ls="transition2d:9;slidedelay:7000;">					
                        <img src="img/pages/parodontologija.jpg" alt="" class="ls-bg">
                    </div>
                </section>
            </div>
            <!--/ slider -->
            ...
            <section class="page-title">
                <div class="grid-row clearfix">
                    <h1><?php echo $lang['page']['opstastomatologija']['Parodontologija']['title']; ?></h1>					
                    <nav class="bread-crumbs">
                        ...
                        <a href="#"><?php echo $lang['page']['opstastomatologija']['Parodontologija']['title']; ?></a>
                    </nav>
                </div>
            </section>
            <!--/ page title -->
