        ...
        <div class="page">
            ...
            <section class="page-title">
                <div class="grid-row clearfix">
                    <h1><?php echo $lang['page']['protetika']['inleji']['title'] ?></h1>					
                    <nav class="bread-crumbs">
                        ...
                        <a href="#"><?php echo $lang['page']['protetika']['inleji']['title']; ?></a>
                    </nav>
                </div>
            </section>
            <!--/ page title -->
            ...
            <main class="page-content">
                <div class="grid-row">
                    <div class="grid-col grid-col-9">
                        ...
                        <p><?php echo $lang['page']['protetika']['inleji']['opis'] ?></p><br>
                        <div class="kandidat">
                            <b><?php echo $lang['page']['protetika']['kandidati']; ?></b>
                        </div>
                        <p><?php echo $lang['page']['protetika']['inleji']['kandidati']; ?></p><br>
                        <div class="materijal">
