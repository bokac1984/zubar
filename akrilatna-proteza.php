            ...
            <section class="page-title">
                <div class="grid-row clearfix">
                    ...
                    <nav class="bread-crumbs">
                        ...
                        <a href="#"><?php echo $lang['page']['protetika']['akrilatna']['title']; ?></a>
                    </nav>
                </div>
            </section>
            <!--/ page title -->
            ...
            <main class="page-content">
                <div class="grid-row">
                    <div class="grid-col grid-col-9">
                        ...
                        <p><?php echo $lang['page']['protetika']['akrilatna']['opis'] ?></p><br>
                        <div class="kandidat">
                            <b><?php echo $lang['page']['protetika']['kandidati']; ?></b>
                        </div>
                        <p><?php echo $lang['page']['protetika']['akrilatna']['kandidati']; ?></p><br>
                        <!-- rezervacije -->
